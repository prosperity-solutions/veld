...
Veld ships a custom Caddy build with the `veld-inject` plugin, bundled in the release tarball. It is installed to `~/.local/lib/veld/caddy`. This is a Veld-owned installation — completely separate from any system or Homebrew Caddy.
