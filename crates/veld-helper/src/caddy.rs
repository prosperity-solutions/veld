...
/// Default path to the Caddy binary managed by Veld.
const CADDY_BIN: &str = "/usr/local/lib/veld/caddy";

/// Caddy admin API base URL.
const CADDY_ADMIN_API: &str = "http://localhost:2019";

/// Directory holding TLS certificates generated by mkcert.
    ...
    pub fn new() -> Self {
        Self {
            inner: Arc::new(Mutex::new(CaddyState {
                caddy_bin: PathBuf::from(CADDY_BIN),
                child_pid: None,
            })),
