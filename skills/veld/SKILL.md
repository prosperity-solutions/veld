...
triggers:
  ...
  - feedback loop
  - "*.localhost"
compatibility: Requires veld v16.44.1+
...
veld share my-feature --ttl 3600            # TTL in seconds; unbounded, one share
                                            # Defaults: 7200 peer / 3600 web, from
