...
triggers:
  ...
  - feedback loop
  - "*.localhost"
compatibility: Requires veld v16.71.0+
...
enforces — is in [reference/pane-sessions.md](reference/pane-sessions.md).**
Field table: [reference/config.md](reference/config.md#idepanes).
